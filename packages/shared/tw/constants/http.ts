/** HTTP methods, status codes, CSP directives. */
...
export const CSP_DIRECTIVES = new Set([
  ...
  "frame-src", "worker-src", "frame-ancestors", "form-action",
  "navigate-to", "base-uri", "manifest-src", "plugin-types",
  "require-sri-for", "sandbox", "report-uri", "report-to",

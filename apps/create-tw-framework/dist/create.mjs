#!/usr/bin/env node
/**
 * create-tw-framework — the fastest way to start a TW Framework project.
 *
...
function printVersion() {
  ...
  process.stdout.write(`create-tw-framework ${version}\n`);
}
...
try {
  ...
  process.stderr.write(
    "\n  Could not resolve the tw-framework CLI.\n" +
      ...
      "    npm install create-tw-framework\n" +
      "    npx create-tw-framework my-app\n\n"
  );
  process.exit(1);
}
